...
public class Turret extends SubsystemBase implements NTSendable {
  ...
  @Getter private double velocityKp = 31.931; // 23.221;
  @Getter private double velocityKi = 0.0; // try lowering this
  @Getter private double velocityKd = 1.5432 * 4.0; // 0.8981;
  ...
  public Turret() {
    ...
    motionMagicConfigs.MotionMagicCruiseVelocity = 640; // 160; // Target cruise velocity of 80 rps
  ...
  public void initSendable(NTSendableBuilder builder) {
    ...
    builder.addDoubleProperty("setPoint", this::getPositionRotations, null);
